...
function articleCreator(obj) {
  ...
  content.textContent = obj.firstParagraph;
  contentTwo.textContent = obj.secondParagraph;
  contentThree.textContent = obj.thirdParagraph;
  span.textContent = "Expand Section";
...
data.map(function(item, index) {
  articles.appendChild(articleCreator(data[index]));
});
